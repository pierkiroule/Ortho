...
export const cards: MoodCard[] = [
  ...
  { id: 'sens', emoji: '🎯', label: 'Je trouve que ça en vaut la peine', parentLabel: 'Votre enfant trouve que ça en vaut la peine', group: 'resource' },
  { id: 'projection', emoji: '✨', label: 'J’imagine mon futur sourire', parentLabel: 'Votre enfant imagine son futur sourire', group: 'resource' },
  { id: 'soutien', emoji: '🤝', label: 'Je me sens aidé et soutenu', parentLabel: 'Votre enfant se sent aidé et soutenu', group: 'resource' },
  { id: 'fierte', emoji: '🏆', label: 'Je suis fier de mes progrès', parentLabel: 'Votre enfant est fier de ses progrès', group: 'resource' },
  { id: 'resultat', emoji: '😁', label: 'Je suis content du résultat', parentLabel: 'Votre enfant est content du résultat', group: 'resource' },
  ...
  { id: 'sommeil', emoji: '🌙', label: 'Mon sommeil est perturbé par l’appareil', parentLabel: 'Le sommeil de votre enfant est perturbé par l’appareil', group: 'difficulty' },
  ...
  { id: 'irritations', emoji: '🩹', label: 'L’appareil provoque des irritations dans la bouche', parentLabel: 'L’appareil provoque des irritations dans la bouche de votre enfant', group: 'difficulty' },
  { id: 'duree', emoji: '⏳', label: 'J’aimerais que ça aille plus vite', parentLabel: 'Votre enfant aimerait que ça aille plus vite', group: 'difficulty' },
  ...
  { id: 'regard', emoji: '🙈', label: 'Le regard des autres me préoccupe', parentLabel: 'Le regard des autres préoccupe votre enfant', group: 'difficulty' },
  { id: 'manger', emoji: '🍽️', label: 'Manger est parfois compliqué', parentLabel: 'Manger est parfois compliqué pour votre enfant', group: 'difficulty' },
